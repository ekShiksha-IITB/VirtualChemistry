...
INSERT INTO chemicals(name,nature,chemFormula,color,state,odour,nfactor,density,molarMass,colorInWater)
VALUES('Hydrochloric Acid','Acid','HCl','colorless','liquid','odorless',1,0.0015,36.5,'colorless');
...
INSERT INTO chemicals(name,nature,chemFormula,color,state,odour,nfactor,density,molarMass,colorInWater)
VALUES('Ammonium sulphate ','Neutral and Others','(NH4)2SO4','white','solid','odorless',0,1.77,132,'light white');

INSERT INTO chemicals(name,nature,chemFormula,color,state,odour,nfactor,density,molarMass,colorInWater)
VALUES('Pottasium Chloride','Neutral and Others','KCl','white','solid','odorless',0,1.984,74.5,'colorless');

INSERT INTO chemicals(name,nature,chemFormula,color,state,odour,nfactor,density,molarMass,colorInWater)
VALUES('Lithium Chloride','Neutral and Others','LiCl','white','solid','odorless',0,2.068,42.5,'colorless');

INSERT INTO chemicals(name,nature,chemFormula,color,state,odour,nfactor,density,molarMass,colorInWater)
VALUES('Pottasium perchlorate','Neutral and Others','KClO4','white','solid','odorless',0,2.5239,138.5,'colorless');

INSERT INTO chemicals(name,nature,chemFormula,color,state,odour,nfactor,density,molarMass,colorInWater)
VALUES('Sodium sulphate','Neutral and Others','Na2SO4','white','solid','odorless',0,2.664,142,'colorless');

INSERT INTO chemicals(name,nature,chemFormula,color,state,odour,nfactor,density,molarMass,colorInWater)
VALUES('Sodium nitrate','Neutral and Others','NaNO3','white','solid','sweet',0,2.257,85,'colorless');

INSERT INTO chemicals(name,nature,chemFormula,color,state,odour,nfactor,density,molarMass,colorInWater)
VALUES('Lithium sulphate','Neutral and Others','Li2SO4','white','solid','odorless',0,2.221,110,'colorless');

INSERT INTO chemicals(name,nature,chemFormula,color,state,odour,nfactor,density,molarMass,colorInWater)
VALUES('Lithium nitrate','Neutral and Others','LiNO3','white','solid','odorless',0,2.38,69,'colorless');
