...
function Mixture(sol='H2O',solcol='blue',vsol,narr,carr,colarr,natarr,nfarr,cf,mol,den,mm,colw,temp=25,ind){
    this.Solvent=sol;
    ...
    for(var i=0;i<narr.length;i++){
        this.Chemicals[i]=new Chemical(narr[i],carr[i],colarr[i],natarr[i],nfarr[i],cfarr[i],molarr[i],denarr[i],mmarr[i],colwarr[i],temparr[i]);
    }
...
function Chemical(nc,cc,col,nat,nf,cf,mol,den,mm,colw,temp=25){
    this.Name=nc;
